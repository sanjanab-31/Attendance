...
export default function Sidebar({ isOpen, onClose }) {
  ...
  return (
    <aside
      className={`fixed md:sticky top-0 bottom-0 left-0 w-64 border-r border-slate-200 bg-white flex flex-col h-screen z-40 transition-transform duration-300 transform md:transform-none shadow-sm ${
    ...
    >
      ...
      <div className="h-16 flex items-center gap-3 px-6 border-b border-slate-100">
        ...
        <span className="font-bold text-primary-dark tracking-tight text-base">
          ESA ATTENDANCE
        </span>
      </div>
      ...
      <div className="p-4 border-t border-slate-100 bg-slate-50/50">
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1 overflow-hidden">
            <p className="text-sm font-bold text-slate-800 truncate">{currentUser?.email || 'User'}</p>
