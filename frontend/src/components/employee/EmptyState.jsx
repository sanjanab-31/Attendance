...
export default function EmptyState() {
  return (
    <div className="p-12 text-center bg-white border border-slate-200 rounded-lg shadow-sm flex flex-col items-center">
      ...
      <h3 className="text-sm font-bold text-primary-dark">No Employees Found</h3>
      ...
      <Link
        ...
        className="mt-5 inline-flex items-center gap-2 px-4 py-2 bg-primary-dark hover:bg-[#163c03] text-white font-bold text-xs uppercase tracking-wider rounded-lg transition-colors shadow-sm"
      >
