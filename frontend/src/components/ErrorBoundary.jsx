        ...
        <div className="min-h-screen bg-slate-50 flex items-center justify-center p-6 font-sans">
          <div className="max-w-md w-full bg-white border border-slate-200 p-8 rounded-2xl shadow-lg text-center space-y-5">
            ...
            <div className="space-y-2">
              <h2 className="text-lg font-extrabold text-[#0d2702]">Something went wrong</h2>
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-5 py-2.5 bg-[#0d2702] hover:bg-[#163c03] text-white text-xs font-bold uppercase tracking-wider rounded-xl transition-all shadow"
            >
